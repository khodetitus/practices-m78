...
from users.models import User, show, Manager, finding, commeent, show_coment, ordering, find_user_id, find_order_id, \
    ordering_item, show_ordering
...
def sign_in():
    ...
    if User.sign_in(username, pasword):
        ...
        logging.basicConfig(
            filename="C:/Users/masoud/Desktop/Maktab/maktab/week13/HW13/M78__FileStore-main/core/log.log", filemode='a',
            level=logging.INFO)
...
def Login():
    ...
    user.insert()
    logging.basicConfig(filename="C:/Users/masoud/Desktop/Maktab/maktab/week13/HW13/M78__FileStore-main/core/log.log",
...
def comment():
    if Config.status_sign_in:
        ...
        if commeent(file_id, username, email, description):
            ...
            show_comment()
            logging.basicConfig(
                filename="C:/Users/masoud/Desktop/Maktab/maktab/week13/HW13/M78__FileStore-main/core/log.log",
                filemode='a', level=logging.INFO)
