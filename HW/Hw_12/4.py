...
for job in job_elements :
    if i == 0:    
        ...
        print(nime_shab)
    i+=1
azan_sobh = datetime.strptime(azane_maghreb.replace(" ",""), "%H:%M")
azan_sobh.strftime("%H:%M")
print("azan_sobh" ,azan_sobh)
tolooe_khorshid = datetime.strptime(azane_maghreb.replace(" ",""), "%H:%M")
tolooe_khorshid.strftime("%H:%M")
print("tolooe_khorshid" ,azan_sobh)
azan_zohr = datetime.strptime(azane_maghreb.replace(" ",""), "%H:%M")
azan_zohr.strftime("%H:%M")
print("azan_zohr" ,azan_sobh)
ghoroobe_khorshid = datetime.strptime(azane_maghreb.replace(" ",""), "%H:%M")
...
database ={"azan_sobh": (azan_sobh.ctime()),
 ...
 "nime_shab":nime_shab}
filename= "C:/Users/Amir/Desktop/Maktab/maktab/week12/HW12/4.json"
